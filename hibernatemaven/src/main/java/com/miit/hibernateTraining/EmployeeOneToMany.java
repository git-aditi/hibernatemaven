...
@Entity
@Table(name="EMPLOYEE_ONE_TO_MANY")
public class EmployeeOneToMany implements Serializable{
	...
	public EmployeeOneToMany(String firstname, String lastname, String phone) {
